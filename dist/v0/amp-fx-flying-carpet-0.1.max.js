...
/** @const */
var EXPERIMENT = 'amp-fx-flying-carpet';
...
var AmpFlyingCarpet = (function (_AMP$BaseElement) {
  ...
  AmpFlyingCarpet.prototype.buildCallback = function buildCallback() {
    ...
    if (!_srcExperiments.isExperimentOn(this.win, EXPERIMENT)) {
      _srcLog.dev().warn(EXPERIMENT, 'Experiment ' + EXPERIMENT + ' disabled');
  ...
  AmpFlyingCarpet.prototype.assertPosition = function assertPosition() {
    ...
    _srcLog.user().assert(layoutBox.top >= viewportHeight, '<amp-fx-flying-carpet> elements must be positioned after the first ' + 'viewport: %s Current position: %s. Min: %s', this.element, layoutBox.top, viewportHeight);
    _srcLog.user().assert(layoutBox.bottom <= docHeight - viewportHeight, '<amp-fx-flying-carpet> elements must be positioned before the last ' + 'viewport: %s Current position: %s. Max: %s', this.element, layoutBox.bottom, docHeight - viewportHeight);
  };
  ...
  AmpFlyingCarpet.prototype.collapsedCallback = function collapsedCallback(child) {
    ...
    if (index > -1) {
      ...
      if (this.totalChildren_ == 0) {
        return this.attemptChangeHeight(0).then(function () {
          _this3. /*OK*/collapse();
        }, function () {});
      }
    }
...
},{"../../../build/amp-fx-flying-carpet-0.1.css":1,"../../../src/experiments":5,"../../../src/layout":6,"../../../src/log":7,"../../../src/style":11}],3:[function(require,module,exports){
exports.__esModule = true;
/**
 * Copyright 2016 The AMP HTML Authors. All Rights Reserved.
 *
...
},{"./cookies":4,"./url":13}],6:[function(require,module,exports){
exports.__esModule = true;
...
},{"./experiments":5,"./log":7,"./style":11,"./types":12}],7:[function(require,module,exports){
exports.__esModule = true;
...
},{"./mode":9,"./mode-object":8}],8:[function(require,module,exports){
exports.__esModule = true;
...
},{"./config":3,"./log":7,"./mode":9,"./string":10,"./types":12}]},{},[2])
