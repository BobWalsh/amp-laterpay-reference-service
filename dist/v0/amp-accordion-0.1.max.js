(self.AMP = self.AMP || []).push({n:"amp-accordion", f:(function(AMP) {(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
var AmpAccordion = (function (_AMP$BaseElement) {
  ...
  AmpAccordion.prototype.buildCallback = function buildCallback() {
    ...
    this.sections_.forEach(function (section, index) {
      ...
      header.addEventListener('click', _this.onHeaderClick_.bind(_this));
    });
  };
  ...
  AmpAccordion.prototype.getSessionState_ = function getSessionState_() {
    try {
      var sessionStr = this.win. /*OK*/sessionStorage.getItem(_srcLog.dev().assertString(this.id_));
      return (/** @type {!Object} */JSON.parse(_srcLog.dev().assertString(sessionStr))
      );
    } catch (e) {
  ...
  AmpAccordion.prototype.setSessionState_ = function setSessionState_() {
    ...
    try {
      this.win. /*OK*/sessionStorage.setItem(_srcLog.dev().assertString(this.id_), sessionStr);
    } catch (e) {
      _srcLog.dev().fine('AMP-ACCORDION', e.message, e.stack);
    }
  };
...
},{"../../../build/amp-accordion-0.1.css":1,"../../../src/layout":6,"../../../src/log":7,"../../../src/url":13}],3:[function(require,module,exports){
exports.__esModule = true;
/**
 * Copyright 2016 The AMP HTML Authors. All Rights Reserved.
 *
