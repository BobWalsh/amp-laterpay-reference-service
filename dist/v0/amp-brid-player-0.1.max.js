(self.AMP = self.AMP || []).push({n:"amp-brid-player", f:(function(AMP) {(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/**
...
var AmpBridPlayer = (function (_AMP$BaseElement) {
  ...
  AmpBridPlayer.prototype.layoutCallback = function layoutCallback() {
    var playerID = _srcLog.user().assert(this.element.getAttribute('data-player'), 'The data-player attribute is required for <amp-brid-player> %s', this.element);

    var partnerID = _srcLog.user().assert(this.partnerID_, 'The data-partner attribute is required for <amp-brid-player> %s', this.element);
    ...
    var src = 'https://services.brid.tv/services/iframe/' + encodeURIComponent(feedType) + '/' + encodeURIComponent(this.feedID_) + '/' + encodeURIComponent(partnerID) + '/' + encodeURIComponent(playerID) + '/0/1';
  ...
  AmpBridPlayer.prototype.pauseCallback = function pauseCallback() {
    if (this.iframe_ && this.iframe_.contentWindow) {
      this.iframe_.contentWindow. /*OK*/postMessage('Brid|pause', 'https://services.brid.tv');
    }
  };
