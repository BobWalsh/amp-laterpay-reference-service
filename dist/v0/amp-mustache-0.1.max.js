(self.AMP = self.AMP || []).push({n:"amp-mustache", f:(function(AMP) {(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
},{"../../../src/sanitizer":6,"../../../third_party/mustache/mustache":12}],2:[function(require,module,exports){
exports.__esModule = true;
/**
...
},{"./mode":5,"./mode-object":4}],4:[function(require,module,exports){
exports.__esModule = true;
...
/** @const {!Array<string>} */
var WHITELISTED_ATTRS = ['fallback', 'href', 'on', 'placeholder'];
  ...
  var parser = _third_partyCajaHtmlSanitizer.htmlSanitizer.makeSaxParser({
    'startTag': function (tagName, attribs) {
      ...
      for (var i = 0; i < attribs.length; i += 2) {
        ...
        emit('="');
        if (attrValue) {
          emit(_third_partyCajaHtmlSanitizer.htmlSanitizer.escapeAttrib(resolveAttrValue(tagName, attrName, attrValue)));
        }
        emit('"');
      }
      emit('>');
...
},{"../third_party/caja/html-sanitizer":11,"./config":2,"./log":3,"./srcset":7,"./url":10}],7:[function(require,module,exports){
exports.__esModule = true;
...
},{"./config":2,"./log":3,"./mode":5,"./string":8,"./types":9}],11:[function(require,module,exports){
exports.__esModule = true;
