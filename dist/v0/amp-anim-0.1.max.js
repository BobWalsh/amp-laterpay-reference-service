(self.AMP = self.AMP || []).push({n:"amp-anim", f:(function(AMP) {(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
var AmpAnim = (function (_AMP$BaseElement) {
  ...
  AmpAnim.prototype.updateImageSrc_ = function updateImageSrc_() {
    ...
    this.loadPromise_ = this.loadPromise(this.img_)['catch'](function (error) {
      if (!_this2.img_.getAttribute('src')) {
        return;
      }
      throw error;
    });
...
},{"../../../src/layout":5,"../../../src/log":6,"../../../src/srcset":9,"../../../src/style":11}],2:[function(require,module,exports){
exports.__esModule = true;
/**
...
},{"./cookies":3,"./url":13}],5:[function(require,module,exports){
exports.__esModule = true;
...
},{"./experiments":4,"./log":6,"./style":11,"./types":12}],6:[function(require,module,exports){
exports.__esModule = true;
...
},{"./config":2,"./log":6,"./mode":8,"./string":10,"./types":12}]},{},[1])
