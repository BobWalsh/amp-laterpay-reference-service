(self.AMP = self.AMP || []).push({n:"amp-selector", f:(function(AMP) {(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
var AmpSelector = (function (_AMP$BaseElement) {
  ...
  AmpSelector.prototype.buildCallback = function buildCallback() {
    _srcLog.user().assert(_srcExperiments.isExperimentOn(this.win, 'amp-selector'), 'Experiment amp-selector is disabled.');
  ...
  AmpSelector.prototype.clickHandler_ = function clickHandler_(event) {
    ...
    if (!el.hasAttribute('option')) {
      el = _srcDom.closest(el, function (e) {
        return e.hasAttribute('option');
      }, this.element);
    }
...
},{"../../../src/dom":4,"../../../src/experiments":5,"../../../src/log":6}],2:[function(require,module,exports){
exports.__esModule = true;
/**
 * Copyright 2016 The AMP HTML Authors. All Rights Reserved.
 *
...
},{"../third_party/css-escape/css-escape":12,"./log":6,"./types":10}],5:[function(require,module,exports){
exports.__esModule = true;
...
},{"./cookies":3,"./url":11}],6:[function(require,module,exports){
exports.__esModule = true;
...
},{"./config":2,"./log":6,"./mode":8,"./string":9,"./types":10}],12:[function(require,module,exports){
exports.__esModule = true;
