...
function processMessage(win, message) {
  ...
  var iframeElement = getFrameElement(win, win['ampInaboxIframes'], message.source);
  // TODO: build a map from source to iframeElement.
  _srcLog.dev().info(TAG, '[' + iframeElement.id + '] ' + message.data);
}
...
},{"../../src/log":2,"../../third_party/babel/custom-babel-helpers":5}],2:[function(require,module,exports){
...
},{"./mode":4,"./mode-object":3}],3:[function(require,module,exports){
exports.__esModule = true;
